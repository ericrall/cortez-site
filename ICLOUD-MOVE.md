...
**This repo now lives at `~/Developer/cortez-site`.** It was moved out of `~/Documents` on
...
| | |
|---|---|
| path | `~/Documents/cortez-site` |
| size | 448K |
| conflict copies present | **0** |
| uncommitted (tracked) | 0 |
| untracked | 0 |
| own `.venv` | no |
| remote | present — history recoverable if the move goes wrong. |
